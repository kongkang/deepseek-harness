...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  WaiBrainBootstrap: 'waibrain.md',
  WaiBrainCloseConversationRequest: 'waibrain.md',
  WaiBrainCloseConversationResult: 'waibrain.md',
  WaiBrainConversationRequest: 'waibrain.md',
  WaiBrainConversationResult: 'waibrain.md',
  WaiBrainCreateConversationRequest: 'waibrain.md',
  WaiBrainCreateConversationResult: 'waibrain.md',
  WaiBrainPromptRequest: 'waibrain.md',
  WaiBrainPromptResult: 'waibrain.md',
  WaiBrainSaveAgentRequest: 'waibrain.md',
  WaiBrainSaveAgentResult: 'waibrain.md',
  WaiBrainSelectAgentRequest: 'waibrain.md',
  WaiBrainSelectAgentResult: 'waibrain.md',
  WaiBrainSelectConversationRequest: 'waibrain.md',
  WaiBrainSelectConversationResult: 'waibrain.md',
